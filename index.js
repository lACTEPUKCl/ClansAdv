...
> •Возраст: от 16 лет ( допускаются исключения).
> •Устойчивость к стрессу и умение сохранять спокойствие в сложных ситуациях.
> •Игровой стаж: от 50 часов в игре. ( допускаются исключения)
...
const message4 = {
  embeds: [
    new EmbedBuilder()
      .setColor(16711680)
      .setDescription(
        `### *[IMPERA Corp — играет чтобы побеждать.](https://discord.gg/ys5cPmW7hy)*
...
Возраст **18+** с возможными исключениями, **микрофон**, **адекватность** — **это минимум**. **Желание расти** и быть **частью команды** — **это главное**.
...
const message8 = `# ION Corporation приглашает новых игроков в организованный клан по Squad.

# Мы — команда игроков, которые ценят командную игру, адекватное общение и взаимоуважение.

# 🤝 Что у нас есть?

> ⚡️ регулярные совместные игры
> ⚡️тренировки и отработка командных действий
> ⚡️ дружный и спокойный коллектив
> ⚡️помощь новичкам и развитие игроков
> ⚡️ турнирное участие
> ⚡️VIP - статус на серверах для активных участников

# 🎯 Кого мы ищем:

> ⚡️игроков, которые хотят играть в команде
> ⚡️людей с микрофоном 🎤
> ⚡️адекватных и спокойных участников
> ⚡️тех, кто умеет слушать и общаться

🚀 Набор ограничен\! Если ты хочешь стать частью команды — не откладывай вступление.

https://discord.gg/ioncorporation`;
